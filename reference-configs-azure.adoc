...
| Unterstützte Festplattentypen ^4^ 3+| Standard-HDD-verwaltete Festplatten, Standard-SSD-verwaltete Festplatten und Premium-SSD-verwaltete Festplatten 
|===
Hinweise:
...
| Maximale Systemkapazität
(Festplatten + Objekt-Storage) | 2 tib ^1^ | 10 tib | 368 tib | 368 tib pro Lizenz 
